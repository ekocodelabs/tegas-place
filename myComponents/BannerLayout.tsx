...
export default function BannerLayout() {
  ...
  const whatsappUrl = `https://wa.me/2347034382723?text=${whatsappMessage}`; // Replace XXXXXXXXXX with your Nigerian phone number

  return (
    <section className="relative w-full h-full md:h-screen overflow-hidden bg-emerald-950 flex items-center justify-center">
      ...
      <video
        ...
        muted
        playsInline
        poster="/images/aboutimage2.jpg" // High-end placeholder image from public/images
      ...
      <div className="absolute top-10 right-10 z-10 opacity-10 animate-pulse hidden md:block">
        <Image
          src="/images/aboutimage3.jpg" // Decorative pattern assets from public/images
      ...
      <div className="relative z-20 max-w-6xl mx-auto px-6 text-center flex flex-col items-center gap-6 md:gap-8 mb-20 md:mb-32">
        {/* Elite Subtle Badge */}
        ...
        <p className="text-zinc-300 text-base md:text-sm max-w-2xl font-light leading-relaxed">
        ...
        <div className="flex flex-col sm:flex-row gap-4 mt-2 w-full sm:w-auto">
          ...
          >
            <a href="/pricelist">Explore Remedies</a>
          </Button>
        </div>
      </div>

      {/* 5. Minimalistic Bottom Border Gradient Transition */}
      <div className="absolute bottom-0 left-0 w-full h-px bg-linear-to-r from-transparent via-amber-500/40 to-transparent z-20" />
    </section>
  );
}
